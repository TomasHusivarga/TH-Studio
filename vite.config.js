  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        blogSmtpExplanation: resolve(__dirname, 'blog/co-je-smtp-preco-je-dolezite-ho-nastavit-wordpress.html'),
        blogWordPressEmails: resolve(__dirname, 'blog/preco-wordpress-neposiela-emaily-ako-opravit.html'),
        blogContactFormSetup: resolve(__dirname, 'blog/ako-nastavit-kontaktny-formular-wordpress.html'),
        blogWooShippingSetup: resolve(__dirname, 'blog/ako-nastavit-dopravu-woocommerce.html'),
        blogWooShippingMissing: resolve(__dirname, 'blog/preco-sa-vo-woocommerce-nezobrazuje-doprava-v-pokladni.html'),
        blogWooPaymentsSetup: resolve(__dirname, 'blog/ako-nastavit-platby-woocommerce.html'),
        blogWebsitePrice: resolve(__dirname, 'blog/kolko-stoji-wordpress-webstranka.html'),
        ...
        blogSmtpExplanationEn: resolve(__dirname, 'en/blog/what-is-smtp-and-why-it-matters-for-wordpress.html'),
        blogWordPressEmailsEn: resolve(__dirname, 'en/blog/why-wordpress-is-not-sending-emails-how-to-fix.html'),
        blogContactFormSetupEn: resolve(__dirname, 'en/blog/how-to-set-up-wordpress-contact-form-that-works.html'),
        blogWooShippingSetupEn: resolve(__dirname, 'en/blog/how-to-set-up-woocommerce-shipping.html'),
        blogWooShippingMissingEn: resolve(__dirname, 'en/blog/why-woocommerce-shipping-does-not-show-at-checkout.html'),
        blogWooPaymentsSetupEn: resolve(__dirname, 'en/blog/how-to-set-up-woocommerce-payments.html'),
        blogWebsitePriceEn: resolve(__dirname, 'en/blog/how-much-does-a-wordpress-website-cost.html'),
